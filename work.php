...
<html>
	...
	<body>
		...
		<div id="work">
			...
			<div class="row">
				<a href="http://www.wildflourwilliamstown.com" target="_blank" class="col-7 workExample stretch-12">
					<img class="col-12"  alt="Wildflour Bakery screenshot" src="imgs/thumbs/wildflour.png"/>
				</a>	
				...
				<div class="col-4 stretch-12">
					...
					<p>
						A simple site for Williamstown's Wildflour Bakery.
					</p>
				</div>				
			</div>
			...
			<div class="row">
				<a href="http://www.boardinhand.com" target="_blank" class="col-7 workExample stretch-12">
					<img class="col-12"  alt="Board in Hand screenshot" src="imgs/thumbs/board_in_hand.png"/>
				</a>	
